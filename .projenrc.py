...
class PythonOWStatsParserProject(PythonProject):
    black = None
    flake8 = None
    isort = None
    ...
    def __init__(
        ...
        **options,
        ...
        super(PythonOWStatsParserProject, self).__init__(**options)
    ...
    def post_synthesize(self):
        super(PythonOWStatsParserProject, self).post_synthesize()
        if self.pre_commit:
            self.setup_pre_commit()


project = PythonOWStatsParserProject(
    author_email="46250621+Nbslab@users.noreply.github.com",
    author_name="Nbslab",
